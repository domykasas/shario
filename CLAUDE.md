...
- **Current Version**: 0.0.1-rc.5 (Release Candidate - 2025-07-10)
- **Language**: Go 1.20+
- **GUI**: Fyne framework  
...
- **Current**: v0.0.1-rc.5 - Release candidate with all core P2P functionality + workflow fixes + Windows PowerShell compatibility
- **Next**: v0.0.1 - Stable release (after testing rc.5)
