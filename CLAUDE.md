...
- **Current Version**: 1.0.0-rc.5 (Release Candidate - 2025-07-10)
- **Language**: Go 1.20+
- **GUI**: Fyne framework  
...
- **Current**: v1.0.0-rc.5 - Release candidate with all core P2P functionality + workflow fixes + Windows build optimization
- **Next**: v1.0.0 - **FIRST STABLE RELEASE** (after testing rc.5)
