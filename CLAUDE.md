...
- **Current Version**: 0.0.1-rc.8 (Release Candidate - 2025-07-10)
- **Language**: Go 1.20+
- **GUI**: Fyne framework  
...
- **Current**: v0.0.1-rc.8 - Release candidate with all core P2P functionality + workflow fixes + RPM packaging compatibility
- **Next**: v0.0.1 - Stable release (after testing rc.8)
