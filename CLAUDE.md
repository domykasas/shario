...
- **Current Version**: 1.0.0-rc.8 (Release Candidate - 2025-07-11)
- **Language**: Go 1.20+
- **GUI**: Fyne framework  
...
- **Current**: v1.0.0-rc.8 - Release candidate with expanded platform support (7 platforms)
- **Next**: v1.0.0 - **FIRST STABLE RELEASE** (after testing rc.8)
